...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		// 문자열 비교
		if(str1 == str2) {
			System.out.println("str, str2 주소값이 같다.");
		}else {
			System.out.println("str, str2 주소값이 다르다.");
			
		if(str1.equals(str2)) {
			System.out.println("str, str2 문자열이 같다.");
		}else {
			System.out.println("str, str2 문자열이 다르다.");
		}
		...
		// 문자열 인덱스
		int index1 = message.indexOf("1");		// 문자열 앞에서 부터 소문자 1 검색 후 인덱스 변환
		int index2 = message.lastIndexOf("1");	// 문자열 뒤에서 부터 소문자 1 검색 후 인덱스 변환
