...
public class operatorTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("n1 : " + n1); //숫자 연산이 아니라 문자합
		...
		boolean res4 = (var3 > 3) || (var4 > 3); //var3은 3보다 크고 그리고 var4는 5보다 크다.
		boolean res5 = (var3 > 4); //var3은 var4보다 크지 않다.
